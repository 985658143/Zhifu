<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\wamp64\www\Zhifu\public/../app/index\view\admin\order.html";i:1609937462;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
  <title>智付商城后台</title>
            ...
            <div class="top-content">
              ...
              <table class="table">
                ...
                <tr>
                  ...
                  <td><?php echo $order['payid']; ?></td>
                  <td><?php echo $order['totalprice']; ?></td>
                  <td><?php echo $order['date']; ?></td>
                  <td ><?php echo $order['status']; ?></td>
                  <td><input type="button" href="javascript:" class="btn btn-primary" onclick="seInfo('<?php echo $order['pid']; ?>')" value="查看详情"></td>
                  <td>
                    <a href="javascript:" class="btn btn-primary" onclick="upOd('<?php echo $order['pid']; ?>')" id="send">发货</a>
                    <a href="javascript:" class="btn btn-primary" onclick="deleteOd('<?php echo $order['pid']; ?>')">删除</a>
                  </td>
                </tr>
...
<script>
  ...
  function seInfo(id){
    window.location = '<?php echo url("Admin/orderdetails"); ?>' + '?id=' + id;
  }
  function deleteOd(id){
    if (confirm("确定删除该订单吗？")){
      window.location = '<?php echo url("Admin/dodeleteOd"); ?>' + '?id=' + id;
    }
  }
  function upOd(id){
    window.location = '<?php echo url("Admin/addlogistics"); ?>' + '?id=' + id;
  }
