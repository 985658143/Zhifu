<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\wamp64\www\Zhifu\public/../app/index\view\login\login.html";i:1608534632;}*/ ?>
<!DOCTYPE HTML>
<html lang="en">
<head>
  ...
  <table>
    ...
    <tr>
      <td colspan="2" class="text-td2">
        ...
        <input type="button" id="b1" value="用户"/>
      </td>
    </tr>
  </table>
...
<script>
  $(function () {
    ...
    $("#b3").on('click', function () {
      let admin = document.getElementById("name");
            ...
            $.ajax({
              ...
              success: function (response) {
                ...
                if (response.code) {
                  //登录成功
                  setTimeout(function () {
                    window.location.href = "/index/Admin/adminpage"
                  }, response.wait * 200);
                } else {
                  //后端处理有错误
                  $("#status").html(response.msg);
